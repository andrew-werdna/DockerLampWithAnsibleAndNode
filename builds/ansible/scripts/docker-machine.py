    ...
    return {
        ...
        "vars": {
            ...
            "docker_host_url": "tcp://{}:2376".format(
                getDockerMachineInfo(dmName, "{{.Driver.IPAddress}}").decode('utf-8')
            ),

            "docker_host_cert_path": getDockerMachineInfo(dmName, "{{.HostOptions.AuthOptions.StorePath}}").decode('utf-8'),
